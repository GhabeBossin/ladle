  ...
  return knex('users').del()
    .then(function () {
      return Promise.all([
        ...
        knex('users').insert([
          { is_new: false, achievements: true, username: "user1", first_name: 'Timtim', last_name: 'Tim', password: 'password', group: 'beginner', cards_played: 67, sessions_played: 4, wrong_counter: 40, mode_setting: 'learn_easy', is_admin: true },
          ...
          { is_new: false, achievements: true, username: "user3", first_name: 'Mateo', last_name: 'Turbo', password: 'password', group: 'beginner', cards_played: 234, sessions_played: 12, wrong_counter: 68, mode_setting: 'learn_medium', is_admin: false },
          ...
          { is_new: false, achievements: true, username: "user8", last_name: 'Ann', first_name: 'Jo', password: 'password', group: 'intermediate', cards_played: 230, sessions_played: 76, wrong_counter: 9, mode_setting: 'drill_hard', is_admin: true },
        ])
      ]);
    })
}
